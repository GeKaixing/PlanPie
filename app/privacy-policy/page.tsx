        ...
        <>
            <main className="flex justify-center items-center min-h-screen bg-gray-50 px-4 py-12">
                <div className="max-w-3xl w-full bg-white shadow-md rounded-xl p-8">
                    <h1 className="text-3xl font-bold text-center mb-2">🔐 隐私政策（Privacy Policy）</h1>
                    <p className="text-center text-sm text-gray-500 mb-6">Last Updated: 2025-05-17</p>

                    <p>Towel（以下简称“我们”或“本网站”）尊重并保护用户的隐私。本隐私政策说明我们如何收集、使用、披露和保护你的个人信息。</p>

                    <h2 className="text-xl font-semibold mt-6">1. 我们收集的信息</h2>
                    <ul className="list-disc list-inside">
                        <li><strong>你提供的信息：</strong>如注册账号时填写的姓名、邮箱等。</li>
                        <li><strong>自动收集的信息：</strong>如浏览器类型、IP 地址、访问时间、使用行为等。</li>
                        <li><strong>Cookies 和类似技术：</strong>用于提升网站功能和个性化体验。</li>
                    </ul>

                    <h2 className="text-xl font-semibold mt-6">2. 信息的使用方式</h2>
                    <p>我们可能将你的信息用于以下目的：</p>
                    <ul className="list-disc list-inside">
                        <li>提供和维护网站服务；</li>
                        <li>改进用户体验；</li>
                        <li>发送与你账户或服务相关的通知；</li>
                        <li>回应你的咨询和支持请求；</li>
                        <li>符合法律法规要求。</li>
                    </ul>

                    <h2 className="text-xl font-semibold mt-6">3. 信息的分享</h2>
                    <p>我们不会将你的个人信息出售给第三方。除以下情形外，我们不会分享你的信息：</p>
                    <ul className="list-disc list-inside">
                        <li>你已同意分享；</li>
                        <li>为提供服务而必须与合作伙伴共享；</li>
                        <li>符合法律要求或响应合法请求。</li>
                    </ul>

                    <h2 className="text-xl font-semibold mt-6">4. 信息的存储与保护</h2>
                    <p>我们会采取合理的安全措施来保护你的信息不被未经授权的访问、泄露、使用或更改。但需注意，没有任何系统是绝对安全的。</p>

                    <h2 className="text-xl font-semibold mt-6">5. 你的权利</h2>
                    <p>你有权访问、更正或删除你的个人信息。如需行使这些权利，请通过下方联系方式联系我们。</p>

                    <h2 className="text-xl font-semibold mt-6">6. 第三方服务</h2>
                    <p>本网站可能使用第三方服务（如分析工具或支付服务），这些服务可能收集与你使用本网站相关的信息，并受其各自隐私政策约束。</p>

                    <h2 className="text-xl font-semibold mt-6">7. 儿童隐私</h2>
                    <p>本网站不面向 13 岁以下儿童。如我们发现收集了该年龄段儿童的个人信息，将及时删除。</p>

                    <h2 className="text-xl font-semibold mt-6">8. 政策更新</h2>
                    <p>我们可能不时更新本隐私政策。更新后的政策将在本页面发布，并更新“Last Updated”日期。</p>

                    <h2 className="text-xl font-semibold mt-6">9. 联系我们</h2>
                    <p>如有任何关于本隐私政策的问题，请通过 x2890901420@gmail.com 与我们联系。</p>
                </div>
            </main>
            <main className="flex justify-center items-center min-h-screen bg-gray-50 px-4 py-12">
                <div className="max-w-3xl w-full bg-white shadow-md rounded-xl p-8">
