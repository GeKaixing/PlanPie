// app/terms/page.tsx（适用于 App Router）
        ...
        <>
            ...
            <main className="flex justify-center items-center min-h-screen bg-gray-50 px-4 py-12">
                <div className="max-w-3xl w-full bg-white shadow-md rounded-xl p-8">
                    <h1 className="text-3xl font-bold text-center mb-2">📄 服务条款（Terms of Service）</h1>
                    <p className="text-center text-sm text-gray-500 mb-6">Last Updated: 2025-05-17</p>

                    <p>欢迎使用 <strong>Towel</strong>（以下简称“本网站”、“我们”或“我们的”）。请在使用本网站之前仔细阅读本服务条款（以下简称“条款”）。通过访问或使用 Towel，你表示你已阅读、理解并同意受本条款的约束。</p>

                    <h2 className="text-xl font-semibold mt-6">1. 使用资格</h2>
                    <p>你必须年满 13 岁才能使用本网站。如果你未满 18 岁，你必须在父母或监护人的监督下使用本网站。</p>

                    <h2 className="text-xl font-semibold mt-6">2. 用户账户</h2>
                    <p>如你创建账户，你需提供准确、完整的信息，并妥善保管账户信息。你对所有使用你账户所进行的行为负全部责任。</p>

                    <h2 className="text-xl font-semibold mt-6">3. 禁止行为</h2>
                    <ul className="list-disc list-inside">
                        <li>违反任何适用法律法规；</li>
                        <li>干扰或破坏网站服务；</li>
                        <li>未经授权访问其他用户账户或数据；</li>
                        <li>发布违法、有害、淫秽、欺诈、骚扰性内容。</li>
                    </ul>

                    <h2 className="text-xl font-semibold mt-6">4. 知识产权</h2>
                    <p>本网站及其内容（包括但不限于文字、图片、标识、设计等）均归 Towel 或其授权人所有，受版权和其他法律保护。未经授权不得复制、修改或分发。</p>

                    <h2 className="text-xl font-semibold mt-6">5. 第三方链接</h2>
                    <p>Towel 可能包含指向第三方网站的链接。我们不对这些网站的内容或隐私政策负责。</p>

                    <h2 className="text-xl font-semibold mt-6">6. 服务变更和终止</h2>
                    <p>我们保留随时修改、暂停或终止本网站服务的权利，恕不另行通知。我们也可出于任何原因限制或终止你对本网站的访问。</p>

                    <h2 className="text-xl font-semibold mt-6">7. 免责声明</h2>
                    <p>Towel 按“原样”提供服务，不作任何明示或暗示的担保。我们不保证服务不会中断或无错误。</p>

                    <h2 className="text-xl font-semibold mt-6">8. 责任限制</h2>
                    <p>在法律允许的最大范围内，Towel 对因使用或无法使用本网站所引起的任何间接、附带、特殊或惩罚性损害不承担责任。</p>

                    <h2 className="text-xl font-semibold mt-6">9. 法律适用</h2>
                    <p>本条款受 [你的网站运营所在地，例如中国/美国等] 的法律管辖，并依其解释。如有争议，双方应提交至有管辖权的法院解决。</p>
