...
export default async function Home() {
  ...
  if (user) {
    ...
    return (
      ...
      focus:border-gray-900  hover:border-gray-900 rounded-2xl flex flex-col gap-4
      ">
          ...
          <ul className="space-y-2">
            {todos.map(item => <li key={item.id} className="border  flex items-center justify-between border-gray-200 hover:border-gray-900  rounded-2xl p-4">
